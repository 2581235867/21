...
-- UI inspirée de 'ztx clan' avec bannière transparente
...
local function ToggleUI()
    ...
    local tween = TweenService:Create(Frame, TweenInfo.new(0.5, Enum.EasingStyle.Quint, Enum.EasingDirection.Out), {Size = UDim2.new(0.8, 0, 0.3, 0)})
    tween:Play()
end

local function CloseUI()
    local tween = TweenService:Create(Frame, TweenInfo.new(0.5, Enum.EasingStyle.Quint, Enum.EasingDirection.In), {Size = UDim2.new(0, 0, 0, 0)})
    tween:Play()
